  ...
  (0, _createClass3.default)(Scrollspy, null, [{
    ...
    get: function get() {
      return {
        ...
        currentAria: _propTypes2.default.string,
  ...
  (0, _createClass3.default)(Scrollspy, [{
    ...
    value: function render() {
      ...
      var items = _react2.default.Children.map(children, function (child, idx) {
        ...
        var grandchildrenWithProps = _react2.default.Children.map(grandchildren, function (grandchild) {
          return _react2.default.cloneElement(grandchild, { 'aria-current': _this3.state.inViewState[idx] ? _this3.props.currentAria : 'false' });
        });
